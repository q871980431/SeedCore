...
public:
	...
	virtual const char * GetBuff(s32 index, s32 &buffLen) = 0;
...
#define MYSQL_QUERY(query, escapeHandler, table)	QuerySQLCommand query(&escapeHandler, sizeof(escapeHandler), MysqlEscapeStrFun, table)
#define MYSQL_UPDATE(update, escapeHandler, table)  UpdateSQLCommand update(&escapeHandler, sizeof(escapeHandler), MysqlEscapeStrFun, table)
#define MYSQL_INSERT(insert, escapeHandler, table)  InsertSQLCommand insert(&escapeHandler, sizeof(escapeHandler), MysqlEscapeStrFun, table)
#define MYSQL_SAVE(save, escapeHandler, table)		SaveSQLCommand save(&escapeHandler, sizeof(escapeHandler), MysqlEscapeStrFun, table)
