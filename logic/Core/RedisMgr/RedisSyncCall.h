public:
	virtual REDIS_RESULT Del(const std::string &strKey, bool &del, s32 threadIdx = MAIN_THREAD_IDX) override;
...
public:
	...
	virtual REDIS_RESULT MSet(const StringMap &mapFileds, s32 threadIdx = MAIN_THREAD_IDX) override;
...
public:
	...
	virtual REDIS_RESULT HDel(const std::string &strKey, const StringVector &strFileds, s32 threadIdx = MAIN_THREAD_IDX) override;
	virtual REDIS_RESULT HLen(const std::string &strKey, s64 &iOutVal, s32 threadIdx = MAIN_THREAD_IDX) override;
	virtual REDIS_RESULT HExists(const std::string &strKey, const std::string &strFiled, bool &exists, s32 threadIdx = MAIN_THREAD_IDX) override;
	...
	virtual REDIS_RESULT HVals(const std::string &strKey, StringVector &vecOutVals, s32 threadIdx = MAIN_THREAD_IDX) override;	//Abase 暂不支持
																															...
																															//List
public:
	virtual REDIS_RESULT PushListTail(const std::string &strKey, const std::string &strValue, u32 &iLen, s32 threadIdx = MAIN_THREAD_IDX) override;
	virtual REDIS_RESULT PushListTailBatch(const std::string &strKey, const std::vector<std::string> &vecValue, u32 &iLen, s32 threadIdx = MAIN_THREAD_IDX) override;
	...
	virtual REDIS_RESULT LPush(const std::string &strKey, const std::string &strValue, u32 &iLen, s32 threadIdx = MAIN_THREAD_IDX)override;
	virtual REDIS_RESULT LPush(const std::string &strKey, const StringVector &vecValue, u32 &iLen, s32 threadIdx = MAIN_THREAD_IDX)override;
	virtual REDIS_RESULT LPushX(const std::string &strKey, const std::string &strValue, u32 &iLen, s32 threadIdx = MAIN_THREAD_IDX) override;
	virtual REDIS_RESULT LPushX(const std::string &strKey, const StringVector &vecValue, u32 &iLen, s32 threadIdx = MAIN_THREAD_IDX)override;
	virtual REDIS_RESULT RPush(const std::string &strKey, const std::string &strValue, u32 &iLen, s32 threadIdx = MAIN_THREAD_IDX)override;
	virtual REDIS_RESULT RPush(const std::string &strKey, const StringVector &vecValue, u32 &iLen, s32 threadIdx = MAIN_THREAD_IDX)override;
	virtual REDIS_RESULT RPushX(const std::string &strKey, const std::string &strValue, u32 &iLen, s32 threadIdx = MAIN_THREAD_IDX)override;
	virtual REDIS_RESULT RPushX(const std::string &strKey, const StringVector &vecValue, u32 &iLen, s32 threadIdx = MAIN_THREAD_IDX)override;
...
public:
	...
	virtual REDIS_RESULT SRem(const std::string &strKey, const StringVector &strMembers, s32 threadIdx = MAIN_THREAD_IDX) override;
