...
{
public:
	virtual const char * GetExecSql(IEscapeStringHandler *pEscapeStrHandler) { return "select * from account;"; };
...
public:
	...
	virtual const char * GetExecSql(IEscapeStringHandler *pEscapeStrHandler) { return "select * from accoun;"; };
	virtual void OnFail(core::IKernel *kernel, const s32 errorCode, const char *errorInfo);
protected:
private:
	s32 _id;
